...
dbCFree = database[(database['Free'] == 1 ) & (database['Mode'] == 0)]  #Only collect data when free-charging
dbD = database[database['Mode'] == 1]                                   #Only collect data when discharging

## Voltage Graph
fig1 = plt.figure()
plt.scatter(dbCFixed['Time'],dbCFixed['V(Charge)'],label='charging (free)')
plt.scatter(dbCFree['Time'],dbCFree['V(Charge)'],label='charging (fixed)')
plt.scatter(dbD['Time'],dbD['V(Discharge)'],label='discharging')
...
## Current Graph
fig2 = plt.figure()
plt.scatter(dbCFixed['Time'],dbCFixed['I(Charge)'],label='charging (free)')
plt.scatter(dbCFree['Time'],dbCFree['I(Charge)'],label='charging (fixed)')
plt.scatter(dbD['Time'],dbD['I(Discharge)'],label='discharging')
plt.autoscale(True, 'both', True)
...
## Power Graph
fig3 = plt.figure()
plt.scatter(dbCFixed['Time'],dbCFixed['P(Charge)'],label='charging (free)')
plt.scatter(dbCFree['Time'],dbCFree['P(Charge)'],label='charging (fixed)')
plt.scatter(dbD['Time'],dbD['P(Discharge)'],label='discharging')
plt.autoscale(True, 'both', True)
